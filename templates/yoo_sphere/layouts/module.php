...
if ($style == '') {
	...
	if ($module->position == 'innertop-a') $style = 'blank';
	if ($module->position == 'innertop-b') $style = 'blank';
	if ($module->position == 'innerbottom-a') $style = 'blank';
	if ($module->position == 'innerbottom-b') $style = 'blank';
	if ($module->position == 'sidebar-a') { $style = 'box'; $color = 'dark'; }
	if ($module->position == 'sidebar-b') { $style = 'box'; $color = 'dark'; }
}
