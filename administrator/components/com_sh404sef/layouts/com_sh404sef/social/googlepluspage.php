...
?>
      <!-- Google+ Page button -->
      <a class="google-page-badge" onclick="_sh404sefSocialTrack.GPageTracking('<?php echo $displayData['page']; ?>', '<?php echo $displayData['url']; ?>')" href="https://plus.google.com/<?php echo $displayData['page']; ?>/?prsrc=3">
      <?php echo ShlMvcLayout_Helper::render('com_sh404sef.social.googlepluspage_' . $displayData['googlePlusPageSize'], $displayData); ?>		
 	  </a>	
      <!-- End Google+ Page button -->				
