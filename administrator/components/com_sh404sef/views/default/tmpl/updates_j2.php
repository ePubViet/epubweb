...
<?php if(!$this->updates->status) : ?>
    ...
    <?php if (Sh404sefConfigurationEdition::$id == 'full') : ?>
    <tr>
    	<td colspan="2" align="center">
    	<small>Powered by <a href="https://www.akeebabackup.com/software/akeeba-live-update.html">Akeeba Live Update</a></small>
    	</td>
    </tr>
	<?php 
	     endif;
