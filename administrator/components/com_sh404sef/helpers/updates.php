...
class Sh404sefHelperUpdates
{
	...
	private static $_endPoint = 'http://u1.weeblr.com/public/direct/sh404sef/legacy';
	private static $_configEndPoint = 'http://u1.weeblr.com/public/direct/sh404sef/config';
